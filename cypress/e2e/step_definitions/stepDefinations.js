...
Then("Check that the all functionality is available", () => {
    ...
    cy.wait(data.oneSecond)
    cy.xpath(locator.catrgory).should('have.text', 'CATEGORIES')
    cy.wait(data.oneSecond)
    cy.xpath(locator.catrgoryPhone).should('have.text', 'Phones')
    cy.wait(data.oneSecond)
    cy.xpath(locator.catrgoryLaptop).should('have.text', 'Laptops')
    cy.wait(data.oneSecond)
    cy.xpath(locator.catrgoryMonitor).should('have.text', 'Monitors')
    cy.wait(data.oneSecond)
...
Then("Check that the category lists are available", () => {
    cy.xpath(locator.catrgory).should('be.visible')
    cy.xpath(locator.catrgory).should('have.text', 'CATEGORIES')
    cy.wait(data.oneSecond)
    cy.xpath(locator.catrgoryPhone).should('be.visible')
    cy.xpath(locator.catrgoryPhone).should('have.text', 'Phones')
    cy.wait(data.oneSecond)
    cy.xpath(locator.catrgoryLaptop).should('be.visible')
    cy.xpath(locator.catrgoryLaptop).should('have.text', 'Laptops')
    cy.wait(data.oneSecond)
    cy.xpath(locator.catrgoryMonitor).should('be.visible')
    cy.xpath(locator.catrgoryMonitor).should('have.text', 'Monitors')
    cy.wait(data.oneSecond)
})
When("Click on the Mobiles category", () => {
    cy.xpath(locator.catrgoryPhone).click()
    cy.wait(data.oneSecond)
})
...
When("Click on the Laptops category", () => {
    cy.xpath(locator.catrgoryLaptop).click()
    cy.wait(data.oneSecond)
})
...
When("Click on the Monitors category", () => {
    cy.xpath(locator.catrgoryMonitor).click()
    cy.wait(data.oneSecond)
})
Then("Check that the Monitor items are displayed", () => {
    cy.xpath(locator.montorApple).should('be.visible')
    cy.xpath(locator.montorApple).should('have.text', 'Apple monitor 24')
    cy.wait(data.oneSecond)
    cy.xpath(locator.montorAsus).should('be.visible')
    cy.xpath(locator.montorAsus).should('have.text', 'ASUS Full HD')
    cy.wait(data.oneSecond)
